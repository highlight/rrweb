...
export declare function hookSetter<T>(
  target: T,
...
export declare function isBlocked(
  node: Node | null,
  blockClass: blockClass,
): boolean;
export declare function isIgnored(n: Node | INode): boolean;
export declare function isAncestorRemoved(
  target: INode,
  mirror: Mirror,
): boolean;
...
export declare function queueToResolveTrees(
  queue: addedNodeMutation[],
): ResolveTree[];
export declare function iterateResolveTree(
  tree: ResolveTree,
...
export declare function isIframeINode(
  node: INode | ShadowRoot,
): node is HTMLIFrameINode;
export declare function getBaseDimension(
  node: Node,
  rootIframe: Node,
): DocumentDimension;
export declare function hasShadowRoot<T extends Node>(
  n: T,
): n is T & {
